...
日期：2026-09-04。运行内容版本：`v0.4B-stage-one.3`。固定路明非，序章至第二章；不含 AI 或第三章实装。
...
- `v0.4B.md` 是当前参考稿《龙族试玩前三章剧情设计稿-v0.4B.md》的逐字节快照，权威正文、对白、选项标签、根词和反馈均由此提取。文件 SHA-256：`8661981c17e5aa61ba3667b8a3ce7c9f071ffe79a0d8e9cabe9f43b4e80212f2`。
...
- 2026-09-05 实装浏览器批注2、6：CH1-02“你第一反应是”改为“而是”；CH2-08-DIGNITY共同对白改为“少你一个也不耽误”。现有 Markdown / Word 原稿及快照同步并标注。批注1、3、4、5仍待讨论，未改正文。支持 .1 / .2 旧存档中对应正文的精确升级，保留选择、旗标与检查点。

## 节点与选项

运行包有 **39 个静态节点、63 个存储选项、57 个独立选项标签**；其中 29 个存储选项有 `feedback`。复制计数来自 CH1-06、CH1-07 的共同选项。39 个节点包括获批的 CANON 已知情版本，比审计报告最初估算的 38 多一个。以下行号对应首次接入快照；既有新增标注及段落使 CH1-01 之后的行号顺延4行；2026-09-05两条修订注释再各增加2行，定位以节点 ID 为准。
