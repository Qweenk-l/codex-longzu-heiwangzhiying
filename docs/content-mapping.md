...
日期：2026-09-04。运行内容版本：`v0.4B-stage-one.4`。固定路明非，序章至第二章；不含 AI 或第三章实装。
...
- `v0.4B.md` 是当前参考稿《龙族试玩前三章剧情设计稿-v0.4B.md》的逐字节快照，权威正文、对白、选项标签、根词和反馈均由此提取。文件 SHA-256：`c5cd03c24ac261f8cd816a9d4cfd04272460457587de6455d010dc546ebb1706`。
