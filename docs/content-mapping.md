...
日期：2026-09-04。运行内容版本：`v0.4B-stage-one.2`。固定路明非，序章至第二章；不含 AI 或第三章实装。
...
- `v0.4B.md` 是当前参考稿《龙族试玩前三章剧情设计稿-v0.4B.md》的逐字节快照，权威正文、对白、选项标签、根词和反馈均由此提取。文件 SHA-256：`a433c72174f1f7ffaa024e26a919198bfe8998cc28246e79330081f3e8a1b5d6`。
...
运行包有 **39 个静态节点、63 个存储选项、57 个独立选项标签**；其中 29 个存储选项有 `feedback`。复制计数来自 CH1-06、CH1-07 的共同选项。39 个节点包括获批的 CANON 已知情版本，比审计报告最初估算的 38 多一个。以下行号对应首次接入快照；本次新增标注及段落后，CH1-01 之后的行号顺延4行。
